...
## Template ToDo list
- [x] Create a new [Community2Enterprise][template] project.
...
- [ ] Click the <kbd>Watch</kbd> button on the top of the [Community2Enterprise][template] to be notified about releases containing new features and fixes.
...
---
Plugin based on the [Community2Enterprise][template].
